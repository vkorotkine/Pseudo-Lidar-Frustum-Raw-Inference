...
BASE_DIR = "/home/vassili/projects/Object_Detection/frustum-pointnets/kitti"
...
if __name__=='__main__':
    ...
    parser.add_argument('--gen_train',default=False, action='store_true', help='Generate train split frustum data with perturbed GT 2D boxes')
    parser.add_argument('--gen_val',default=False,  action='store_true', help='Generate val split frustum data with GT 2D boxes')
    parser.add_argument('--gen_val_rgb_detection', default=True, action='store_true', help='Generate val split frustum data with RGB detection 2D boxes')
