...
if not TESTING:
    parser.add_argument(
        "--datapath", default="./dataset/KITTI/object/training/", help="select model"
    )
    parser.add_argument(
        "--save_path",
        type=str,
...
if TESTING:
    parser.add_argument(
        "--datapath", default="./dataset/KITTI/object/testing/", help="select model"
    )
    parser.add_argument(
        "--save_path",
        type=str,
...
parser.add_argument(
    "--loadmodel", default="./log/pretrained_sceneflow.tar", help="loading model"
)
...
if args.KITTI == "2015":
    ...
    from fr_kitti_inference_lib.pseudo_lidar.psmnet.dataloader import (
        KITTI_submission_loader2012 as DA,
    )
